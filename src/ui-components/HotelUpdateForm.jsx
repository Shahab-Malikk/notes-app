...
export default function HotelUpdateForm(props) {
  ...
  const [hotelRecord, setHotelRecord] = React.useState(hotelModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Hotel, idProp)
        : hotelModelProp;
      setHotelRecord(record);
    };
    queryData();
  }, [idProp, hotelModelProp]);
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || hotelModelProp)}
